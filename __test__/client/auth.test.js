...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Adrianna67',
      password: '51KbJHaDRsD_zTb',
      email: 'Noah.Smith24@gmail.com',
      name: 'Maria O\'Kon',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 715,
      mobileNo: '(842) 899-8895',
      resetPasswordLink: {},
      loginRetryLimit: 807,
      loginReactiveTime: '2024-11-18T23:52:21.227Z',
      id: '656d9a28645265be5abd450e'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Zechariah.Pouros71',
        'password':'sbCKjrzlRiVD7tH',
        'email':'Jeremie87@yahoo.com',
        'name':'Leticia Zboncak',
        'shippingAddress':[{
          '_id':false,
          'pincode':'blue',
          'address1':'Argentina',
        ...
        'wishlist':[{
          '_id':false,
          'productId':'functionalities'
        }],
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'(479) 380-8873',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/client/auth/forgot-password')
      .send({ 'email':'Jeremie87@yahoo.com', });
