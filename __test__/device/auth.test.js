...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      ...
      password: 'qR6PaDgHFzlc2k8',
      email: 'Noble31@gmail.com',
      name: 'Brent Harvey',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 654,
      mobileNo: '(873) 019-6240',
      resetPasswordLink: {},
      loginRetryLimit: 777,
      loginReactiveTime: '2024-07-29T23:44:49.286Z',
      id: '656d9a28645265be5abd44a2'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Avery_Parker3',
        'password':'rzy8QXrtZesZPQ7',
        'email':'Nicola.OKon@yahoo.com',
        'name':'Penny Becker',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Account',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Nicola.OKon@yahoo.com', });
