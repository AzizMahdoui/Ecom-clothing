...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Wendell.Schoen23',
      password: 'v9LhpIH41GQIWLn',
      email: 'Name_Bogisich94@yahoo.com',
      name: 'Irvin Heidenreich',
      shippingAddress: [
        {
          _id: false,
          pincode: 'haptic',
      ...
      userType: 607,
      mobileNo: '(744) 779-6358',
      resetPasswordLink: {},
      loginRetryLimit: 622,
      loginReactiveTime: '2024-09-08T01:56:17.607Z',
      id: '656d9a28645265be5abd4436'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Augustus.Schiller',
        'password':'s4X_iFuxXnXFIgS',
        'email':'Maryse_Abshire@hotmail.com',
        'name':'Miss Guadalupe Zieme',
        'shippingAddress':[{
          '_id':false,
          'pincode':'FTP',
          'address1':'Unbranded',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Maryse_Abshire@hotmail.com', });
